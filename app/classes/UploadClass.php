...
class UploadClass
{
	public static $project_fields = [
		...
		'old_total_units'=>'Previous or Next Project Total Units',
		'unit_type'=>'Unit Type',
	...
	public static $project_per_project = [
		...
		'no_transactions'=>'Number of Transactions',
		'transaction_month'=>'Transaction Month',
		'area_per_unit_type_sqm'=>'Area Per Unit Type sqm',
		'area_per_unit_type_sqf'=>'Area Per Unit Type sf',
		'no_unit_per_unit_type'=>'Number of units per Unit Type',
		'available_unit_type'=>'Available Unit Type',
		'date_avail_unit_updated'=>'Date when Available Unit Type is updated',
		'guide_price'=>'Guide Price',
		'rental_amount'=>'Rental Amt',
		'vacant_date'=>'Vacant Date',
		'furnishing'=>'Furnishing',
	];
