<!-- include CSS -->
{{partial("projtypes/partials/css")}}  

<section class="content-header animated fadeIn">
    <h1>Project Types</h1>
    <ol class="breadcrumb">
        <li><i class="fa fa-wrench fa-fw"></i> Management</li>
        <li class="active">projecttypes</li>
    </ol>
</section>
...
<section class="content animated fadeIn">
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Add New Project</h3>
                </div>
                <form name="projtypes" action="{{ url(link_action) }}" role="form" method="POST" data-remote="data-remote">
                    <div class="box-body">
        ...
        <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-list-ul" aria-hidden="true"></i> List Project Types</h3>
                </div>
                <div class="box-body">
...
<!-- include popup -->
{{partial("projtypes/partials/form")}}  
{{partial("projtypes/partials/deleted")}}  
<!-- include Js -->
{{partial("projtypes/partials/js")}}  