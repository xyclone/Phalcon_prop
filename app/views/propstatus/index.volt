...
<section class="content-header animated fadeIn">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">propertystatus</li>
    </ol>
</section>
...
<section class="content animated fadeIn">
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Add New Property Status</h3>
                </div>
        ...
        <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-list-ul" aria-hidden="true"></i> List Property Status</h3>
                </div>
                <div class="box-body">
...
<!-- include popup -->
{{partial("propstatus/partials/form")}}  
{{partial("propstatus/partials/deleted")}}  
<!-- include Js -->
{{partial("propstatus/partials/js")}}  