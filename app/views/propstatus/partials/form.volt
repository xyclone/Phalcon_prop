    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title"><i class="fa fa-pencil-square-o fa-fw" aria-hidden="true"></i> Update Property Status</h4>
            </div>
            <form name="propstatus_edit" id="propstatus_edit" method="POST" data-remote="data-remote">
