        ...
        <div class="modal-dialog vertical-align-center" role="document">
            <div class="modal-content">
                <div class="modal-header bg-red">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete Property Unit</h4>
                </div>

                <form name="delete" action="{{ url('propunits/deleted') }}" method="POST" data-remote="data-remote">
                    <div class="modal-body">
                        <input type="hidden" name="id" id="id_delete" value="">
                        <p>Are you sure you want to delete property unit "<span id="field" class="text-red"></span>" ?</p>
                    </div>
