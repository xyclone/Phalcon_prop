...
<section class="content animated fadeIn">
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Add New Property Unit</h3>
                </div>
                <form name="propunits" action="{{ url(link_action) }}" role="form" method="POST" data-remote="data-remote">
                    <div class="box-body">
        ...
        <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-list-ul" aria-hidden="true"></i> List Property Units</h3>
                </div>
                <div class="box-body">
...
<!-- include popup -->
{{partial("propunits/partials/form")}}  
{{partial("propunits/partials/deleted")}}  
<!-- include Js -->
{{partial("propunits/partials/js")}}  