    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                {{  erorrSend }}
                <form action="{{ url('login/postForgotPassword') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-paper-plane fa-fw" aria-hidden="true"></i> Send Email</button>
                        </div>
                    </div>
                </form>
            </div>
