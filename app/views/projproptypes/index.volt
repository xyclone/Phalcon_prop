<!-- include CSS -->
{{partial("projproptypes/partials/css")}}  
...
<section class="content animated fadeIn">
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Add New Project Property Type</h3>
                </div>
                <form name="projproptypes" action="{{ url(link_action) }}" role="form" method="POST" data-remote="data-remote">
                    <div class="box-body">
        ...
        <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-list-ul" aria-hidden="true"></i> List Project Property Types</h3>
                </div>
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th align="center"><b>Project Property Type</b></th>
...
<!-- include popup -->
{{partial("projproptypes/partials/form")}}  
{{partial("projproptypes/partials/deleted")}}  
<!-- include Js -->
{{partial("projproptypes/partials/js")}}  