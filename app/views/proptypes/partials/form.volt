    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title"><i class="fa fa-pencil-square-o fa-fw" aria-hidden="true"></i> Update Property Type</h4>
            </div>
            <form name="proptype_edit" id="proptype_edit" method="POST" data-remote="data-remote">
